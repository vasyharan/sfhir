...
pub struct RegulatedAuthorization {
    ...
    /// authorization. An authorization is granted in response to submissions/
    /// applications by those seeking authorization. A case is the administrative
    /// process that deals with the application(s) that relate to this and assesses
    /// them. Note: This area is subject to ongoing review and the workgroup is seeking
    /// implementer feedback on its use (see link at bottom of page).
    pub case: super::regulated_authorization::RegulatedAuthorizationCase,
    ...
    /// body (the 'regulator').
    pub holder: super::reference::Reference,
    ...
    pub intended_use: super::codeable_concept::CodeableConcept,
    ...
    pub regulator: super::reference::Reference,
...
pub struct RegulatedAuthorizationCase {
    ...
    pub application: Vec<super::regulated_authorization::RegulatedAuthorizationCase>,
    /// Relevant date for this case.
    pub date_date_time: String,
    /// Relevant date for this case.
    pub date_period: super::period::Period,
