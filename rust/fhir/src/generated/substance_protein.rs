...
/// or a combination of subunits that are either covalently linked or have a
/// defined invariant stoichiometric relationship. This includes all synthetic,
/// recombinant and purified SubstanceProteins of defined sequence, whether the
/// use is therapeutic or prophylactic. This set of elements will be used to
/// describe albumins, coagulation factors, cytokines, growth factors, peptide/
/// SubstanceProtein hormones, enzymes, toxins, toxoids, recombinant vaccines, and
/// immunomodulators.
...
pub struct SubstanceProtein {
    ...
    pub disulfide_linkage: Vec<super::string::String>,
    ...
    /// multiple times.
    pub subunit: Vec<super::substance_protein::SubstanceProteinSubunit>,
...
pub struct SubstanceProteinSubunit {
    ...
    pub c_terminal_modification: super::string::String,
    /// Unique identifier for molecular fragment modification based on the ISO 11238
    /// Substance ID.
    pub c_terminal_modification_id: super::identifier::Identifier,
    ...
    /// shall be specified.
    pub n_terminal_modification: super::string::String,
    /// Unique identifier for molecular fragment modification based on the ISO 11238
    /// Substance ID.
    pub n_terminal_modification_id: super::identifier::Identifier,
