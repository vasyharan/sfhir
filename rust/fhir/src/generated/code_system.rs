...
pub struct CodeSystem {
    ...
    /// to each other.
    pub case_sensitive: super::boolean::Boolean,
    ...
    pub concept: Vec<super::code_system::CodeSystemConcept>,
    ...
    /// steward.
    pub count: super::unsigned_int::UnsignedInt,
    ...
    pub filter: Vec<super::code_system::CodeSystemFilter>,
    /// The meaning of the hierarchy of concepts as represented in this resource.
    pub hierarchy_meaning: super::code::Code,
    ...
    pub property: Vec<super::code_system::CodeSystemProperty>,
    ...
    pub supplements: super::canonical::Canonical,
    ...
    /// Descriptions related to the content of the CodeSystem. Topics provide a high-
    /// level categorization as well as keywords for the CodeSystem that can be useful
    ...
    /// when the code system is stored on different servers. This is used in [Coding]
    ...
    /// versions can be placed in a lexicographical sequence. This is used in [Coding]
    ...
    pub version_needed: super::boolean::Boolean,
}
...
pub struct CodeSystemConcept {
    ...
    pub definition: super::string::String,
    /// Additional representations for the concept - other languages, aliases,
    /// specialized purposes, used for particular purposes, etc.
    pub designation: Vec<super::code_system::CodeSystemDesignation>,
    ...
    pub property: Vec<super::code_system::CodeSystemProperty1>,
}
...
pub struct CodeSystemFilter {
    ...
    pub operator: Vec<super::code::Code>,
