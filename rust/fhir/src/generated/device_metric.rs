...
pub struct DeviceMetric {
    ...
    /// be performed.
    pub calibration: Vec<super::device_metric::DeviceMetricCalibration>,
    ...
    pub measurement_frequency: super::quantity::Quantity,
    ...
    /// Standby, etc.
    pub operational_status: super::code::Code,
...
pub struct DeviceMetricCalibration {
    ...
    pub state: super::code::Code,
    /// Describes the time last calibration has been performed.
    pub time: super::instant::Instant,
