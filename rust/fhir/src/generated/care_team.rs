...
pub struct CareTeam {
    ...
    /// care team.
    pub participant: Vec<super::care_team::CareTeamParticipant>,
...
pub struct CareTeamParticipant {
    ...
    pub coverage_period: super::period::Period,
    /// When the member is generally available within this care team.
    pub coverage_timing: super::timing::Timing,
    /// Unique id for the element within a resource (for internal references). This may
    /// be any string value that does not contain spaces.
    pub id: super::string::String,
    /// The specific person or organization who is participating/expected to participate
    /// in the care team.
    pub member: super::reference::Reference,
