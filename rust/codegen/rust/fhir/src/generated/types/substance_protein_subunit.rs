...
/// shall be specified.
pub n_terminal_modification: String,
/// Unique identifier for molecular fragment modification based on the ISO 11238
/// Substance ID.
pub n_terminal_modification_id: Identifier,
