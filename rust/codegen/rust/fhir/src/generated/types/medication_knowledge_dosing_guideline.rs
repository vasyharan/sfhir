...
pub administration_treatment: CodeableConcept,
/// Dosage for the medication for the specific guidelines.
pub dosage: Vec<MedicationKnowledgeDosage>,
...
pub patient_characteristic: Vec<MedicationKnowledgePatientCharacteristic>,
/// The overall intention of the treatment, for example, prophylactic, supporative,
/// curative, etc.
pub treatment_intent: CodeableConcept,
}
